...
def main():
    ...
    parser.add_argument(
        ...
        default="",
        help=(
            "Extra arguments appended to COLMAP mapper. This is intentionally "
            "separate from the fixed reconstruction protocol so experimental "
            "solver settings, such as GPU bundle adjustment, are explicit in "
    ...
    mapper_cmd += split_args(args.mapper_args)
    run_cmd(mapper_cmd)
