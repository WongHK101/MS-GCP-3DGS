#!/usr/bin/env python3
"""Prepare CityGS-X's frozen training-only DAv2 depth and multi-view mask prior."""
...
def require_image_inventory(
    ...
    if actual_names != expected_names:
        raise RuntimeError(
            "isolated CityGS-X image root differs from the frozen 82-view train set: "
...
def main() -> int:
    ...
    if len(train_records) != 82 or len(heldout_records) != 12:
        raise RuntimeError(
            f"frozen split must contain 82 train and 12 heldout views, got "
