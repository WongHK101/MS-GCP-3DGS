...
def test_exact_pgsr_one_use_gate_authorizes_only_the_frozen_run() -> None:
...
def test_wrong_run_root_seed_and_budget_fail_closed() -> None:
    ...
    result = check_launch(
        ...
        seed=1,
        budget_value=29999,
        run_root="/root/autodl-tmp/runs/m3m-gcp-native-quarter/pgsr/gcp_3000_20260602/not-authorized",
        run_root_exists=False,
    )
...
def test_non_allowlisted_method_is_denied() -> None:
    ...
    result = check_launch(
        ...
        seed=0,
        budget_value=30000,
        run_root="/root/autodl-tmp/runs/m3m-gcp-native-quarter/rade_gs/gcp_3000_20260602/not-created",
        run_root_exists=False,
    )
    assert result["passed"] is False
